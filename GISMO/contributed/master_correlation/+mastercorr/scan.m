function [WW,WWxc] = scan(WW,WWsnippet,threshold)

%SCAN scans a waveform for events which match a master.
% W = SCAN(W,SNIPPET,THRESHOLD) scans through continuous data,
...
% of W.
%
% [W,XC] = SCAN(W,SNIPPET,THRESHOLD) has same usage except that
...
% SCAN has the ability to syncronize its trigger times on a
...
% EXTRACT. If no such reference in included, the default
...
% scalar time (Matlab format). See COOKBOOK for example use.
%
% See also mastercorr_plot.stats, mastercorr.cookbook, mastercorr.extract

% Author: Michael West, Geophysical Institute, Univ. of Alaska Fairbanks
% $Date: 2011-02-25 11:07:58 -0900 (Fri, 25 Feb 2011) $
% $Revision: 264 $
