...
% [MATCH] = EXTRACT(W) reads waveform W and produces a
...
% to follow MASTERCORR.SCAN. In order to function properly, the properties
% MASTERCORR_TRIG, MASTERCORR_CORR and MASTERCORR_SNIPPET must exist in W.
% See MASTERCORR.SCAN for description of these fields. MATCH is a
...
%
% [MATCH,C] = EXTRACT(W,PRETRIG,POSTRIG) Same as above, however, the
...
% C = EXTRACT(W(1:5)) Note that it is also possible to produce
