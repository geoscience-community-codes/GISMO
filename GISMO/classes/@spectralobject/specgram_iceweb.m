...
debug.print_debug(0, sprintf('%d waveform objects',numel(w)));
...
try
	...
	debug.print_debug(0, 'specgram failed on waveform vector. Trying again, using nonempty rather than fillempty');
