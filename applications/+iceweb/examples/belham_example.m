...
datasourceObject = datasource('miniseed', '/Volumes/data/Montserrat/LaharStudy/%04d/%s/%s/%s.D/%s.%s.%s.%s.D.%04d.%03d.miniseed','year','network','station','channel','network','station','location','channel','year','jday')
...
startTime = datenum(2018,4,3,3,0,0);
endTime = datenum(2018,4,3,4,0,0);
...
PRODUCTS_TOP_DIR = '~/Dropbox/iceweb';
